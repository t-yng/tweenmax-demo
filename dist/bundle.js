...
function startAnimation() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_gsap__["TweenMax"].to($balloon, 3, {
        top: '-150px',        
        onComplete: function() {
            $balloon.remove();
        },
...
function addAnimationBalloon($balloon) {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#js-animation-area').append($balloon);
}

function getBaloonElement() {
    return __WEBPACK_IMPORTED_MODULE_1_jquery___default()(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#animation-balloon-tpl').html());
}
